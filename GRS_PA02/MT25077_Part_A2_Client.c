/* MT25077_Part_A2_Client.c - One-Copy TCP Client */
...
int main(int argc, char *argv[]) {
    ...
    fprintf(stderr, "[A2-Client] one_copy: server=%s:%d msg_size=%d "
    ...
    printf("RESULT,one_copy,%d,%d,%.4f,%.2f,%lld,%lld\n",
