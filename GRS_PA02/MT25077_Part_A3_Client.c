/* MT25077_Part_A3_Client.c - Zero-Copy TCP Client */
...
int main(int argc, char *argv[]) {
    ...
    fprintf(stderr, "[A3-Client] zero_copy: server=%s:%d msg_size=%d "
    ...
    printf("RESULT,zero_copy,%d,%d,%.4f,%.2f,%lld,%lld\n",
